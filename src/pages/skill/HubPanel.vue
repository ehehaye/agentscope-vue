    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <div v-else class="space-y-2">
        ...
        >
          ...
          <div class="flex items-center gap-2">
            <span v-if="card.downloads != null" class="inline-flex items-center gap-1 text-[10px] text-muted-foreground">
              <Icon icon="lucide:download" class="h-3 w-3" />
              {{ card.downloads.toLocaleString() }}
            </span>
            <span v-if="card.updated_at" class="text-[10px] text-muted-foreground">
