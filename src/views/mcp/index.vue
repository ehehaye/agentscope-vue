  ...
  <div class="tw-flex tw-size-full tw-gap-2 tw-p-2">
    <aside class="tw-flex tw-w-64 tw-min-w-0 tw-flex-col tw-overflow-hidden tw-rounded-22px tw-bg-card">
      <div class="tw-flex tw-flex-col tw-gap-y-1 tw-p-5 tw-pb-3">
        <div class="tw-text-xl tw-font-medium tw-tracking-neg-0_02em">MCP 中心</div>
        <div class="tw-text-xs tw-text-muted-foreground">浏览 MCP Hub 并管理已安装的 MCP 工具。</div>
      </div>
      <div class="tw-flex-1 tw-overflow-y-auto tw-px-2">
        <div class="tw-mb-1 tw-px-2 tw-text-xs tw-font-medium tw-text-muted-foreground">我的</div>
        <div
        ...
        >
          ...
          <span class="tw-flex-1 tw-truncate">已安装的 MCP</span>
          <span class="tw-font-mono tw-text-10px tw-text-muted-foreground">{{ mcps.length }}</span>
        </div>

        <div class="tw-mb-1 tw-mt-4 tw-px-2 tw-text-xs tw-font-medium tw-text-muted-foreground">Hub 市场</div>
